  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested ticket" do
        ...
        Ticket.any_instance.should_receive(:update).with({ "title" => "MyString" })
        put :update, {:id => ticket.to_param, :ticket => { "title" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the ticket as @ticket" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Ticket.any_instance.stub(:save).and_return(false)
        put :update, {:id => ticket.to_param, :ticket => { "title" => "invalid value" }}, valid_session
        assigns(:ticket).should eq(ticket)
      end
